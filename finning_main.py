...
def deleteUnknowns():
     a = finning_helper.session.post(finning_queries.SERVICE_END_POINT, data=finning_queries.DELETE_UNKNOWNS_QUERY)
     return a

def heartBeat():
     a = finning_helper.session.post(finning_queries.SERVICE_END_POINT, data=finning_queries.DUMMY_QUERY)
     return a
